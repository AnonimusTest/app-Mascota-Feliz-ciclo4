...
export class MascotaEmpleadoController {
  ...
  @get('/mascotas/{id}/empleados', {
    responses: {
      '200': {
        description: 'Array of Mascota has many Empleado',
        content: {
          'application/json': {
  ...
  async find(
    ...
    return this.mascotaRepository.empleados(id).find(filter);
  }
  ...
  async create(
    ...
    return this.mascotaRepository.empleados(id).create(empleado);
  }
  ...
  async patch(
    ...
    return this.mascotaRepository.empleados(id).patch(empleado, where);
  }
  ...
  async delete(
    ...
    return this.mascotaRepository.empleados(id).delete(where);
  }
}
